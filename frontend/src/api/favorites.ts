...
import type { Track, Album, Artist, Podcast, PaginatedResponse } from '@/types';
...
export const getFavorites = async (entityType: string, page = 1, pageSize = 50): Promise<PaginatedResponse<any>> => {
